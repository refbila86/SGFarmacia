Public Class ProdutoBLL
    ...
    Public Sub RegistarProduto(produtoDTO As ProdutoDTO)
        sql = "INSERT INTO produto (designacao,nome_generico, preco_venda, preco_compra, qtd_cx, validade, pais_origem, criado, user, categoria_id) VALUES ('" & produtoDTO.Designacao & "','" & produtoDTO.Nome_Generico & "', '" & produtoDTO.Preco_Venda & "', '" & produtoDTO.Preco_Compra & "', '" & produtoDTO.Qtd_Cx & "', '" & produtoDTO.Validade & "', '" & produtoDTO.Pais_Origem & "', '" & produtoDTO.Validade & "', 'admin', '" & produtoDTO.Categoria_ID & "')"
        con.ExecutarComandoSQL(sql)
    End Sub
