...
Public Class relCaixaDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGFarmacia.relCaixaDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelCaixaDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relCaixaDiario = New relCaixaDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
