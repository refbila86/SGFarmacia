...
Public Class relVendaDinheiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGFarmacia.relVendaDinheiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelVendaDinheiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relVendaDinheiro = New relVendaDinheiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
