Public Class frmSaidaProdutos
    ...
    Public Sub GravaItensFacturaClasse()
        ...
        For i = 0 To Me.dgVendaItens.Rows.Count - 1
            ...
            'produto_id = Me.dgVendaItens.Item("produto_id", i).Value.ToString '
    ...
    Private Sub dgVendaItens_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgVendaItens.CellContentClick
        ...
        Try
            If colName = "colRemover" Then
                If MsgBox("Tem certeza que deseja remover o produto: " & Me.dgVendaItens.Rows(e.RowIndex).Cells(1).Value.ToString & "?", MsgBoxStyle.YesNo + vbQuestion, "Remover colaborador") = MsgBoxResult.Yes Then
    ...
    Private Sub txtNrVenda_TextChanged(sender As Object, e As EventArgs) Handles txtNrVenda.TextChanged
